...
def run_setup() -> int:
    ...
    answers = SetupAnswers(
        user_id=_ask("ID do usuário", settings.memory_user_id),
        assistant_name=_ask("Como devo me chamar", "Turion"),
        user_name=_ask("Como devo te chamar", "Amigo"),
        style=_ask("Estilo de resposta", "Direto e amigável"),
        preferences=_ask("Preferências ou objetivos", "")
    )
